...
//     const totalWorkingHoursToday = `${String(Math.floor(totalMinutes / 60)).padStart(2, "0")}:${String(totalMinutes % 60).padStart(2, "0")}`;

//     const averageWorkingHoursToday =
//       presentToday > 0
//         ? `${String(Math.floor((totalMinutes / presentToday) / 60)).padStart(2, "0")}:${String(Math.floor((totalMinutes / presentToday) % 60)).padStart(2, "0")}`
//         : "00:00";
